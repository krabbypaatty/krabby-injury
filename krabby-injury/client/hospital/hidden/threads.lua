...
--                                     exports['col_progbar']:ProgressWithStartEvent({
...
--                                             TriggerServerEvent('krabby-injury:server:AttemptHiddenRevive')
--                                         end
--                                     end)
--                                 else
--                                     exports['cfx-hu-notify']:SendAlert('error', Config.Strings.NotHurt)
--                                 end
--                             else
--                                 exports['cfx-hu-notify']:SendAlert('error', Config.Strings.HiddenCooldown)
--                             end
--                         end
--                     end
--                 end
